...
const CartList = () => {
    ...
    return (
        <div className="container">
            <div className="row mt-4 justify-content-center text-center"><b><h2>Tu Carrito</h2></b></div>
            ...
            <div className="row justify-content-center text-center">
                {cartList.map(prod => 
                    <div className="row align-items-center" key={prod.id}>
                        ...
                        <div className="col-lg-1 col-sm-1">
                            <button className="btn btn-primary" onClick={() => removeItem(prod.id)}>Eliminar</button>
                        </div>
                        <hr></hr>
                    </div>
                )}
                ...
                <div className="d-flex justify-content-center mt-5">
                    <button className="btn btn-primary  me-3" onClick={emptyCart}>Vaciar Carrito</button>
                    <Link to="/checkout">
                        <button className="btn btn-primary  ms-3">Procesar Compra</button>
                    </Link>
                </div>
            </div>
        </div>
